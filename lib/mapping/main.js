class TableMap {
    ...
    Helper = {
        ...
        setOnMap: (_x, _y, _tile) => { if(this.Helper.isValidPos(_x, _y)) this.mapping[_y][_x] = _tile },
        moveAnchor: (_anchor, _x, _y) => { _anchor.x += _x; _anchor.y += _y; },
        closeToPath: (_x, _y) => {
            return (this.Helper.isValidPos(_x+1, _y  ) && this.Helper.isPath(this.mapping[_y  ][_x+1]))
                || (this.Helper.isValidPos(_x+1, _y+1) && this.Helper.isPath(this.mapping[_y+1][_x+1]))
                || (this.Helper.isValidPos(_x+1, _y-1) && this.Helper.isPath(this.mapping[_y-1][_x+1]))
                || (this.Helper.isValidPos(_x-1, _y  ) && this.Helper.isPath(this.mapping[_y  ][_x-1]))
                || (this.Helper.isValidPos(_x-1, _y+1) && this.Helper.isPath(this.mapping[_y+1][_x-1]))
                || (this.Helper.isValidPos(_x-1, _y-1) && this.Helper.isPath(this.mapping[_y-1][_x-1]))
                || (this.Helper.isValidPos(_x  , _y+1) && this.Helper.isPath(this.mapping[_y+1][_x  ]))
                || (this.Helper.isValidPos(_x  , _y-1) && this.Helper.isPath(this.mapping[_y-1][_x  ]));
        }
    };
